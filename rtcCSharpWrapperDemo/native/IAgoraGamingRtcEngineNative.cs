...
#region DllImport
    ...
    // standard sdk api
        ...
        [DllImport(MyLibName, CharSet = CharSet.Ansi)]
        protected static extern int startProcessSharedFromAudio();

        [DllImport(MyLibName, CharSet = CharSet.Ansi)]
        protected static extern int stopProcessSharedFromAudio();

        [DllImport(MyLibName, CharSet = CharSet.Ansi)]
        protected static extern void setLogFileFromPath(string filePath);

        [DllImport(MyLibName, CharSet = CharSet.Ansi)]
        protected static extern int stopScreenCaptureEx();

        [DllImport(MyLibName, CharSet = CharSet.Ansi)]
        protected static extern bool enableHardWareEncoder();

        [DllImport(MyLibName, CharSet = CharSet.Ansi)]
        protected static extern int setTextureCapture();
