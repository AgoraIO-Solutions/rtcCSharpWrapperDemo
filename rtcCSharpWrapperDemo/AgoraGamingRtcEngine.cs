    ...
    */
    public sealed class IRtcEngine : IRtcEngineNative
    {
        ...
        private IRtcEngine(RtcEngineConfig engineConfig)
        {
            InitGameObject();
            InitEngineCallback();
            bool initSuccess = IRtcEngineNative.createEngine2(engineConfig.appId, (uint)engineConfig.areaCode);
            mAudioEffectM = AudioEffectManagerImpl.GetInstance(this);
            audioRecordingDeviceManager = AudioRecordingDeviceManager.GetInstance(this);
            audioPlaybackDeviceManager = AudioPlaybackDeviceManager.GetInstance(this);
            videoDeviceManager = VideoDeviceManager.GetInstance(this);
        ...
        */
        ...
        public int SetupLocalVideo(VideoCanvas videoCanvas, uint uid, IntPtr priv)
        {
            return IRtcEngineNative.setupLocalVideo(videoCanvas.hwnd, (int)videoCanvas.renderMode, uid, priv);
        }

        public int SetupRemoteVideo(VideoCanvas videoCanvas, uint uid, IntPtr priv)
        {
            return IRtcEngineNative.setupRemoteVideo(videoCanvas.hwnd, (int)videoCanvas.renderMode, uid, priv);
        }
        ...
        {
            return IRtcEngineNative.setLocalVideoMirrorMode((int)mirrorMode);
        }
        ...
        */
        ...
        public void prepareGame(string exe_path)
        {
            IRtcEngineNative.prepareGame(exe_path);
        }

        public void prepareGameShare()
        {
            IRtcEngineNative.prepareGameShare();
        }
        ...
        public int startProcessSharedFromVideo(int width, int height, int captureFreq, int bitrate)
        {
            return IRtcEngineNative.startProcessSharedFromVideo(width, height, captureFreq, bitrate);
        }

        public int startProcessSharedFromAudio()
        {
            return IRtcEngineNative.startProcessSharedFromAudio();
        }

        public int stopProcessSharedFromAudio()
        {
            return IRtcEngineNative.stopProcessSharedFromAudio();
        }
        ...
        public bool enableHardWareEncoder()
        {
            return IRtcEngineNative.enableHardWareEncoder();
        }
